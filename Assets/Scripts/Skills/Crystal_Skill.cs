...
public class Crystal_Skill : Skill, ISaveManager
{
    ...
    [SerializeField] private UI_SkillTreeSlot unlockMultiStack;
    ...
    protected override void Start()
    {
        ...
        unlockMultiStack.GetComponent<Button>().onClick.AddListener(UnlockMultiStack);
    }
    #region unlock 
    ...
    public void CreatCrystal()
    {
        ...
        currentCystalScript.SetupCrystal(crystalDuration, canExplode, canMoveToEnemy, moveSpeed, FindCloseEnemy(currentCrystal.transform), player);
    ...
    private bool CanUseMultiCrystal()
    {
        if (canUseMultiStacks)
        {
            ...
            if (crystalLeft.Count > 0)
            {
                ...
                newCrystal.GetComponent<Crystal_Skill_Controller>().SetupCrystal(crystalDuration, canExplode, canMoveToEnemy, moveSpeed, FindCloseEnemy(newCrystal.transform), player);
                if (crystalLeft.Count <= 0)
                {
